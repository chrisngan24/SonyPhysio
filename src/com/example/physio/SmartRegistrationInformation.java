...
public class SmartRegistrationInformation extends RegistrationInformation {
     ...
     */
    protected SmartRegistrationInformation(Context context) {
        if (context == null) {
    ...
    public ContentValues getExtensionRegistrationConfiguration() {
        ...
        values.put(Registration.ExtensionColumns.EXTENSION_KEY,
                SmartExtensionsService.EXTENSION_KEY);
    ...
    public boolean isDisplaySizeSupported(int width, int height) {
        return (width == SmartSensorControl.WIDTH && height == SmartSensorControl.HEIGHT);
    }
